...
<body class="bg-gray-100">
  ...
  <div class="max-w-6xl w-full bg-white rounded-lg shadow p-6 md:p-8"> <!-- Perbesar lebar kontainer -->
    <div class="flex justify-center mb-4">
      <h1 class="center text-3xl font-bold dark:text-white">Data Pasien Terdaftar</h1>
    </div>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Rekam Medis</a>
                </td>
            </tr>
        </tbody>
    </table>
