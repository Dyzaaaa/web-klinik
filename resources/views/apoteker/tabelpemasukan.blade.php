...
<body class="bg-gray-100">
  ...
  <div class="max-w-6xl w-full bg-white rounded-lg shadow p-6 md:p-8 mb-5"> 
    <div class="flex justify-center mb-5">
      <h1 class="center text-2xl font-bold dark:text-white">Tabel Pendapatan Klinik</h1>
    </div>
...
<div class="flex justify-center">
  <a href="tambahpemasukan" class="inline-flex items-center text-white bg-[#13C296] hover:bg-gray-500 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 mt-5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Tambah
  </a>
</div>
</body>
